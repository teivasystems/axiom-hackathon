...
> **TEMPLATE** — Copy to `runs/<run>/docs/hackathon_day_runbook.md` and fill in run-specific details (PDI URL, clock length, judge panel, check-in schedule).  
> Do not edit this file for run-specific changes — edit the run copy.
